...
def run(protocol: protocol_api.ProtocolContext):
    ...
    p300.pick_up_tip()
    p300.transfer(190, reservoir["A4"], od_plate_wells[:8], new_tip="never")
    p300.transfer(190, reservoir["A5"], od_plate_wells[8:16], new_tip="never")
    p300.transfer(190, reservoir["A6"], od_plate_wells[16:], new_tip="never")
    p300.transfer(200, reservoir["A6"], [plate["A12"] for plate in od_plates], new_tip="never")
    p300.drop_tip()
